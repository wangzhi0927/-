...
var xmlName = "file:IcTransferCount.ureport.xml"
...
function query(){
	...
	if(type=="D")
	{
		changeFrameSrc(reporturl+"?datetype=D&startDate="+$("#sdate").val()+"&endDate="+$("#edate").val()+"&xmlName="+xmlName);
	}
	if(type=="W")
	{
		changeFrameSrc(reporturl+"?datetype=W&startDate="+$("#sweek").val()+"&endDate="+$("#eweek").val()+"&xmlName="+xmlName);
	}
	if(type=="M")
	{
		changeFrameSrc(reporturl+"?datetype=M&startDate="+$("#smonth").val()+"&endDate="+$("#emonth").val()+"&xmlName="+xmlName);
	}
	if(type=="Q")
	{
		changeFrameSrc(reporturl+"?datetype=Q&startDate="+$("#squarter").val()+"&endDate="+$("#equarter").val()+"&xmlName="+xmlName);
	}
}
