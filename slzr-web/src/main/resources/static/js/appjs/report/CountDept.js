...
var xmlName = "file:Dept.ureport.xml"
...
function query(){
	...
	if(type=="D")
	{
		changeFrameSrc(reporturl+"?datetype=D&startDate="+$("#sdate").val()+"&endDate="+$("#edate").val() + "&deptName="+$("#deptName").val()+"&xmlName="+xmlName);
	}
	if(type=="W")
	{
		changeFrameSrc(reporturl+"?datetype=W&startDate="+$("#sweek").val()+"&endDate="+$("#eweek").val() + "&deptName="+$("#deptName").val()+"&xmlName="+xmlName);
	}
	if(type=="M")
	{
		changeFrameSrc(reporturl+"?datetype=M&startDate="+$("#smonth").val()+"&endDate="+$("#emonth").val() + "&deptName="+$("#deptName").val()+"&xmlName="+xmlName);
	}
	if(type=="Q")
	{
		changeFrameSrc(reporturl+"?datetype=Q&startDate="+$("#squarter").val()+"&endDate="+$("#equarter").val() + "&deptName="+$("#deptName").val()+"&xmlName="+xmlName);
	}
}
