...
var xmlName = "file:Car.ureport.xml"
...
function query(){
	...
	if(type=="D")
	{
		changeFrameSrc(reporturl+"?datetype=D&startDate="+$("#sdate").val()+"&endDate="+$("#edate").val() + "&busNO="+$("#busNO").val()+"&xmlName="+xmlName);
	}
	if(type=="W")
	{
		changeFrameSrc(reporturl+"?datetype=W&startDate="+$("#sweek").val()+"&endDate="+$("#eweek").val() + "&busNO="+$("#busNO").val()+"&xmlName="+xmlName);
	}
	if(type=="M")
	{
		changeFrameSrc(reporturl+"?datetype=M&startDate="+$("#smonth").val()+"&endDate="+$("#emonth").val() + "&busNO="+$("#busNO").val()+"&xmlName="+xmlName);
	}
	if(type=="Q")
	{
		changeFrameSrc(reporturl+"?datetype=Q&startDate="+$("#squarter").val()+"&endDate="+$("#equarter").val() + "&busNO="+$("#busNO").val()+"&xmlName="+xmlName);
	}
}
